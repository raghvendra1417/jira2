            ...
            <aside class="right-side">
                ...
                <section class="content-breadcrumb">
                    <ol class="breadcrumb" style="margin:0 auto;">
                        ...
                        <li><a href="./../../pages/tables/top-menudata.php?view=total-time-spent-assignee-last-month<?php echo $filterFromTo; ?>"><i class="fa fa-table"></i> User Worklogs</a></li>
                            ...
                            <div class="fix0 connectedSortable ui-sortable" style="display: inline-block; margin: 10px; float: none; width: 30%;">
                                ...
                                <div class="box box-success" style="">
                                    ...
                                    <div class="box-body chat" id="chat-box" style="overflow-x: auto;max-height: 250px;">
                                        ...
                                        <!-- chat item -->
                                        <div class="item">
                                            <img src="/JIRA_Reports/img/avatar.png" alt="user image" class="online"/>
                                            <p class="message">
	  ...
	  <script type="text/javascript">
        ...
        <script type="text/javascript">
                   ...
                   var optionSet1 = {
                    ...
                    <?php 
                        ...
                        <?php 
                            ...
                            //Leaves Query
                            $gsql = "select id,username,start_date,end_date,nb_hrs from tbl_leaves where username='".$_REQUEST['username']."' order by added_at asc";
                            $gretData = mysql_query($gsql);
             ...
             <?php }
                    ...
                    //now Leave
                    $gsql = "select id,username,start_date,end_date from tbl_leaves where username='".$_REQUEST['username']."' and DATE(start_date) >= DATE('".date('Y-m-d',strtotime($_REQUEST['from']))."') and DATE(start_date) <= DATE('".date('Y-m-d',strtotime($_REQUEST['to']))."') order by added_at asc";
                    $gretData = mysql_query($gsql);
