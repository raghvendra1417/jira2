...
(function($, window, document) {
	...
	_oExt.oSort = {
		...
		{   
                    ...
                    var x = a == "-" ? 10000000000000 : 0;
                    var y = b == "-" ? 10000000000000 : 0;
                    
                    trimdata =trim(a);
                    
                    if(trimdata.length == 19){
                        if (trim(a) != '') {
		...
		"date-desc": function ( a, b )
		{
                    ...
                    }else if(trimdata.length == 7){
                        if (trim(a) != '') {
                            var frDatea = trim(a).split(' ');
                            
                            frDatea = frDatea[0].split('-');
                            var y = (frDatea[1] + frDatea[0] ) * 1;                     
                        } else {
                            var y = 10000000000000;                    
                        }
                    }
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": show+"_MENU_"+bottom_entries,
				"sZeroRecords": "No matching records found",
				"sEmptyTable": no_data_available,				"sLoadingRecords": "Loading...",
			 ...
			 */
			this.aLengthMenu = [ [ 50, 100, 150, 200, -1 ], [ 50, 100, 150, 200, 'Tous' ] ];//[ 50, 100, 150, 200,250 ];
